...
const plans = [
  {
    ...
    features: [
      "6 Social Media Reels/month",
      "Social Media Management",
      "Creative Concepting Canva posters",
      "Monthly Performance Report",
      "Product Shoot",
      "virtual advertisement upto 2vdo/month(Extra charges applicable)",
    ],
    highlighted: false,
  },
  {
  ...
  },
  {
    ...
    features: [  
      ...
      "Google ads Management weekly 2",
